...
def create_run_eval_bash(bash_save_dir, results_save_dir, route_path, route, checkpoint, logs_save_dir, carla_tm_port_start, benchmark, carla_root):
...
def main():
    try:
        ...
        carla_world_port_start = 2000
        carla_streaming_port_start = 20000
        carla_tm_port_start = 2500
        ...
        for epoch in epochs:
            ...
            for exp_name in exp_names:
                for route in route_files:
                    ...
                    create_run_eval_bash(bash_save_dir, results_save_dir, route_path, route, checkpoint_new_name, logs_save_dir, carla_tm_port_start, benchmark=benchmark, carla_root=carla_root)
                    ...
                    job_file = make_jobsub_file(commands=commands, job_number=job_nr, exp_name=experiment_name_stem, exp_root_name=experiment_name_root, partition=partition)
